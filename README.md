...
c. run_eic.csh :- executes the eic environment.

d. LumiSpecCAL_GETaLMAnalysis.C and LumiSpecCAL.h :- analysis code 
...
e. To submit jobs :- condor_submit run_UserDef.job . Note : Make sure to edit the correct ____Acceptance.cxx / _____Resolution.cxx line.

f. lumi_particles_Resolution.cxx :- to generate particle's HepMC files for CAL standalone simulation.
