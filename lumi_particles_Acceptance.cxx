...
vector<FourVector> pos_origins = { FourVector(0,0,-58000,0) }; //At thin converter location.
...
void lumi_particles_Acceptance(int n_events = 1e5, bool flat=true, bool convert = true, bool displaceVertices = false, double Egamma_start = 5.0, double Egamma_end = 18.0, string out_fname="genParticles.hepmc") {
